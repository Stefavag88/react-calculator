...
class KeyPad extends React.Component {
  render() {
    return (
      <StyledKeyPad>
        <Operator value={"C"} fontSize={"1.1em"} onClick={this.props.onOperatorClick}/>
        <Operator value={"CE"} fontSize={"1.1em"} onClick={this.props.onOperatorClick} />
        <Operator value={"<-"} icon={faBackspace} onClick={this.props.onOperatorClick}/>
        ...
        <Operator value={"+/-"} fontSize={"1.1em"} onClick={this.props.onOperatorClick}/>
        <Number value={0} onClick={this.props.onNumberClick} />
        <Number value={"."} onClick={this.props.onNumberClick}/>
        <Operator value={"="} icon={faEquals} onClick={this.props.onOperatorClick}/>
      </StyledKeyPad>
    );
  }
}
